        ...
        <div className="md:min-h-[calc(100svh-69px)] container mx-auto flex flex-col justify-center items-center">
            <div className="flex flex-col lg:flex-row-reverse justify-center items-center gap-10 lg:gap-16 w-5/6 md:w-8/12 pt-4 mt-10 lg:mt-0">
                <img
                    ...
                    alt="Mykhaylo Pelykh"
                    className={`size-32 lg:size-48 rounded-lg object-cover ${imgInView ? 'animate-fadeLeft' : ''}`}
                    ref={imgRef}
                />
                <div className={`text-center lg:text-start ${textInView ? 'animate-fadeRight' : ''}`} ref={textRef}>
                    ...
                    <div className="mt-4 flex flex-row gap-4 justify-center lg:justify-start">
                        <Link to="https://www.linkedin.com/in/mykhaylo-pelykh-55587017b/" target="_blank">
                        ...
                        <Link to="https://github.com/MikhailP97" target='_blank'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 fill-[#222831] hover:fill-[#335e9e] duration-200 ease-in-out cursor-pointer dark:fill-[#FEFAF6] dark:hover:fill-[#f1d2b5]">
            ...
            <div className={`mt-20 lg:mt-32 w-7/8 md:w-8/12 flex flex-col justify-between items-center gap-4 lg:flex-row ${stackInView ? 'animate-fadeIn' : ''}`} ref={stackRef}>
                <h3 className="font-semibold text-xl underline lg<border-r-none lg:border-r-4 lg:border-r-gray-900 dark:lg:border-r-[#FEFAF6] lg:pr-4 lg:no-underline">Favorite Stack</h3>
